...
export class BooksService {
    ...
    books : BookViewModel[] = [
        ...
        new BookViewModel(6, 'Me Before You', 'https://images-na.ssl-images-amazon.com/images/I/51z4z79P27L._SX277_BO1,204,203,200_.jpg', 'Jojo Moyes', 'Romance', 'Louisa Clark is an ordinary young woman living an exceedingly ordinary life - steady boyfriend, close family that has never been farther afield than their tiny village. She takes a badly needed job working for ex-Master of the Universe Will Traynor, who is wheelchair-bound after an accident. Will has always lived a huge life - big deals, extreme sports, worldwide travel and now he’s pretty sure he cannot live the way he is. A love story for this generation, Me Before You brings to life two people who couldn’t have less in common - a heartbreakingly romantic novel that asks the question \'What do you do when making the person you love happy also means breaking your own heart?\'.', 5.99),
